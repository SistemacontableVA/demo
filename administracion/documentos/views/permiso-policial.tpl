<!-- ============================================================
     PERMISO-POLICIAL.HTML
     Administración > Documentos > Permiso Policial
     ============================================================ -->
...
<div class="max-w-2xl mx-auto px-4 py-8 fade-in">
  ...
  <h1 class="text-verde-oscuro font-bold text-xl mb-1">Permiso Policial</h1>
  ...
  <div class="bg-white rounded-md-plus shadow-card p-6">
    <form id="form-permiso-policial" onsubmit="enviarDocumento(event, 'permiso-policial')">

      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div>
          <label class="block text-[11px] uppercase text-slate-400 font-semibold mb-1">Estación de Policía</label>
          <input type="text" name="estacion" required placeholder="Nombre de la estación"
        ...
        <div>
          <label class="block text-[11px] uppercase text-slate-400 font-semibold mb-1">Lugar exacto</label>
          <input type="text" name="lugar" required placeholder="Dirección o descripción"
            class="w-full px-4 py-2.5 rounded-[12px] border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-azul/40">
        </div>
      </div>
      ...
      <div id="doc-msg-permiso-policial" class="hidden mb-4 text-sm text-center font-medium rounded-lg px-4 py-2"></div>

      <button type="submit" id="btn-generar-permiso-policial"
