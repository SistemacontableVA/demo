<!-- ============================================================
     HOJA-CONVENIO.HTML
     Administración > Documentos > Hoja de Convenio
     ============================================================ -->
...
<div class="max-w-2xl mx-auto px-4 py-8 fade-in">
  ...
  <h1 class="text-verde-oscuro font-bold text-xl mb-1">Hoja de Convenio</h1>
  ...
  <div class="bg-white rounded-md-plus shadow-card p-6">
    <form id="form-hoja-convenio" onsubmit="enviarDocumento(event, 'hoja-convenio')">

      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div>
          <label class="block text-[11px] uppercase text-slate-400 font-semibold mb-1">Entidad colaboradora</label>
        ...
        <div>
          <label class="block text-[11px] uppercase text-slate-400 font-semibold mb-1">Representante legal</label>
          <input type="text" name="representante" required placeholder="Nombre completo"
            class="w-full px-4 py-2.5 rounded-[12px] border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-azul/40">
        </div>
        <div>
        ...
        <div>
          <label class="block text-[11px] uppercase text-slate-400 font-semibold mb-1">Fecha de firma</label>
          <input type="date" name="fechaFirma" required
            class="w-full px-4 py-2.5 rounded-[12px] border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-azul/40">
        </div>
      </div>

      <div class="mb-6">
        <label class="block text-[11px] uppercase text-slate-400 font-semibold mb-1">Objeto del convenio</label>
        <textarea name="objeto" rows="3" required placeholder="Describa el acuerdo de colaboración"
      ...
      <div id="doc-msg-hoja-convenio" class="hidden mb-4 text-sm text-center font-medium rounded-lg px-4 py-2"></div>

      <button type="submit" id="btn-generar-hoja-convenio"
